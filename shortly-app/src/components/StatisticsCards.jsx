        ...
        <div className='d-flex'>
            <div className=' card bg-white border-0 text-dark position-relative py-4'>
                <div className="card-body">
                    <h4  className="card-title fw-bold">Brand Recognition</h4>
            ...
            <div className='bg-info div-bar' style={{width: "2.5rem", height:".3rem"}}>
              
            </div>
            <div className=' card bg-white border-0 text-dark position-relative py-4'>
                <div className="card-body">
                    <h4  className="card-title fw-bold ">Detailed Records</h4>
            ...
            <div className=' card bg-white border-0 text-dark position-relative py-4'>
                <div className="card-body">
                    <h4  className="card-title fw-bold ">Fully Customizable</h4>
